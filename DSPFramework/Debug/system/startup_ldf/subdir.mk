...
system/startup_ldf/app_cplbtab.doj: ../system/startup_ldf/app_cplbtab.c
	...
	ccblkfn -c -file-attr ProjectName="DSPFramework" -proc ADSP-BF533 -flags-compiler --no_wrap_diagnostics -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-8dd7e33c8d4c685092b32299a7061b3c.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -decls-strong -cplbs -gnu-style-dependencies -MD -Mo "system/startup_ldf/app_cplbtab.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	...
	easmblkfn -file-attr ProjectName="DSPFramework" -proc ADSP-BF533 -si-revision 0.6 -g -DCORE0 -D_DEBUG @includes-dd0020d86ed60b105eda5edcdb9189a7.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
